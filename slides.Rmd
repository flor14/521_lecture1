...
```{r t2, fig.align='center', echo = FALSE, out.width=400} 
    knitr::include_graphics("img/mac-terminals.png")
```

.footnote[[Command line crash course - MDS Web Docs](https://developer.mozilla.org/en-US/docs/Learn/Tools_and_testing/Understanding_client-side_tools/Command_line)
] 
